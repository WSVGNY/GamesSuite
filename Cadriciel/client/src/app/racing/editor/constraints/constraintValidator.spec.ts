...
import {
    HALF_TRACK_WIDTH, WALL_DISTANCE_TO_TRACK, WALL_WIDTH,
    TRACK_WIDTH, STARTING_LINE_SEGMENT_MINIMAL_LENGTH
...
describe("Constraints Validator", () => {
    ...
    it("should be long enough", () => {
        ...
        lineGeomerty.vertices.push(new Vector3(
            0,
            TRACK_WIDTH + WALL_DISTANCE_TO_TRACK + WALL_WIDTH + STARTING_LINE_SEGMENT_MINIMAL_LENGTH + 0.01,
            0));
